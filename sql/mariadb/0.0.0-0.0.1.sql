...
-- ----------------------------
-- Records of t_crm_company
-- ----------------------------

-- ----------------------------
-- Table structure for `t_crm_connecter`
-- ----------------------------
DROP TABLE IF EXISTS `t_crm_connecter`;
CREATE TABLE `t_crm_connecter` (
  `id` bigint(20) NOT NULL DEFAULT '0',
  `company_id` bigint(20) DEFAULT NULL,
