...
ALTER TABLE `t_crm_tocontactor`
	ADD COLUMN `user_name` VARCHAR(50) NULL AFTER `content`;
	
	ALTER TABLE `t_crm_contract`
	ADD COLUMN `user_name` VARCHAR(50) NULL DEFAULT NULL AFTER `user_id`;
